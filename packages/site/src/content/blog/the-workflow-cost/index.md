---
title: Deepink Gives You Back Dozens of Hours a Year
image: favorited-note.png
description: |
  Most note-taking apps waste your time in micro-frictions: tiny, repeatable speed bumps that steal seconds, break focus, and quietly tax your attention all day.
...
Even worse, frequent UI detours create a focus cost. [Research on **attention residue**](https://www.sciencedirect.com/science/article/abs/pii/S0749597809000399 "Organizational Behavior and Human Decision Processes - Leroy, 2009") shows that after switching tasks, part of your attention remains stuck on the previous task, reducing performance on the next one. That's why "just a quick menu action" can feel mentally sticky.
...
There is a browser extension called [SponsorBlock](https://sponsor.ajay.app/) that blocks "native ads" on YouTube. Users report advertisement time ranges on videos via the UI, and all other users automatically skip those segments. *The typical ad segment is from 30 seconds to 3–5 minutes long*.
...
They have a public [leaderboard with stats](https://leaderboard.sbstats.uk/) if you're interested.
...
- **Common actions are one-step by default**  
  Not hidden behind a chain of menus and dialogs. This aligns with how task time is actually formed: the [Keystroke-Level Model](https://cacm.acm.org/research/the-keystroke-level-model-for-user-performance-time-with-interactive-systems/) shows it's the sum of small operators.

- **Less hidden navigation for high-frequency actions**  
  When the UI keeps important actions visible, performance and discoverability improve - exactly the problem that [hidden menus create](https://www.nngroup.com/articles/hamburger-menus/).

- **Fewer "breaks in thought" across the day**  
  In a world where [app/site switching is constant](https://hbr.org/2022/08/how-much-time-and-energy-do-we-waste-toggling-between-applications), reducing extra steps isn't cosmetic. It protects focus - especially given what we know about [attention residue during switching](https://www.sciencedirect.com/science/article/abs/pii/S0749597809000399).
