...
export const theme = {
	autocomplete: 'RichEditor__autocomplete',
	...
	layoutItem: 'RichEditor__layoutItem',
	link: 'RichEditor__link',
	list: {
		checklist: 'RichEditor__checklist',
	...
	tableRowStriping: 'RichEditor__tableRowStriping',
	tableSelected: 'RichEditor__tableSelected',
	tableSelection: 'RichEditor__tableSelection',
	text: {
